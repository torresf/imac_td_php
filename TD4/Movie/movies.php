		...
		<ul>
			...
			foreach ($genres as $genre) {
				echo "<li>";
					...
					//On check la checkbox si elle était coché dans la requête précédente
					...
					echo "<label for='{$genre->getName()}' name='genres[]'>{$genre->getName()}</label>";
				echo "</li>";
			}
			?>
		</ul>
